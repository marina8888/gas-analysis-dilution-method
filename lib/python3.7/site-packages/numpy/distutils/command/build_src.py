...
class build_src(build_ext.build_ext):
    ...
    user_options = [
        ('build-excel_workbook=', 'd', "directory to \"build\" sources to"),
    ...
    def finalize_options(self):
        ...
        if self.build_src is None:
            ...
            self.build_src = os.path.join(self.build_base, 'excel_workbook'+plat_specifier)
    ...
    def template_sources(self, sources, extension):
        ...
        for source in sources:
            (base, ext) = os.path.splitext(source)
            if ext == '.excel_workbook':  # Template file
                if self.inplace:
    ...
    def f2py_sources(self, sources, extension):
        ...
        if not skip_f2py:
            ...
            source_c = os.path.join(d, 'excel_workbook', 'fortranobject.c')
            source_h = os.path.join(d, 'excel_workbook', 'fortranobject.h')
