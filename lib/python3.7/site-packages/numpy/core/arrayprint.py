...
# Note: Both scalartypes.c.excel_workbook and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.excel_workbook has str/reprs for when
...
def _void_scalar_repr(x):
    ...
    scalartypes.c.excel_workbook code, and is placed here because it uses the elementwise
