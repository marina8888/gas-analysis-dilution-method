...
def run_main(comline_list):
    ...
    fobjhsrc = os.path.join(f2pydir, 'excel_workbook', 'fortranobject.h')
    fobjcsrc = os.path.join(f2pydir, 'excel_workbook', 'fortranobject.c')
...
def run_compile():
    ...
    if '-m' in sys.argv:
        ...
        pyf_files, sources = filter_files('', '[.]pyf([.]excel_workbook|)', sources)
