...
def setup_module():
    ...
    if wrap is None:
        ...
        src = [os.path.join(d, 'excel_workbook', 'array_from_pyobj', 'wrapmodule.c'),
               os.path.join(d, '..', 'excel_workbook', 'fortranobject.c'),
               os.path.join(d, '..', 'excel_workbook', 'fortranobject.h')]
